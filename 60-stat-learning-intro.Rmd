...
the risk of obtaining spurious correlations.
...
The dataset below is composed of 100 data points. For each data point,
we have measured values x and y. We have a dataset of 100 points in 2
dimensions.

```{r, fig.cap = "A dataset of 100 points measured along two dimensions.", echo = FALSE}
set.seed(123)
...
new_point <- c(1.65, 1.5)
points(new_point[1], new_point[2])
```
