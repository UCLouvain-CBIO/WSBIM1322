...
`r msmbstyle::question_begin()`
Focusing on the region from base 10 to 10.1 million along chromosome
...
```{r, echo = FALSE, fig.cap = "GC content for chomosome 14 (10 - 10.1 Mb)"}
x <- subseq(chr14_dna[[1]], 10 * 10e6, 10.1 * 10e6)
gc_content <- letterFrequencyInSlidingView(x, 1e3,
                                           letters = "GC",
                                           as.prob = TRUE)

plot(gc_content, type = "l", main = "Chromosome 14: 10 - 10.1 Mb")
