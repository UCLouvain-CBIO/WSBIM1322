...
will load the whole genome sequence for Drosophila melanogaster from
UCSC's dm2 build, and calculate the GC content across chromosome 2L.
...
```{r, echo = FALSE, fig.cap = "GC content for chomosome 2L (10 - 11 Mb)"}
