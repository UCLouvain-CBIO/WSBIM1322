...
These are the distances available in the `dist` function. Other that
are of particular interest are 

- Correlation based distance:

See also section 5.3 from [@MSMB] for additional details.
