...
`r msmbstyle::question_begin()`
Using the same value `k = 3`, verify if k-means and hierarchical clustering produce the similar or
identical results on the `giris` data. Visualise the two sets of
results on PCA plots.
