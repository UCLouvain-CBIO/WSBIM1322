...
- provide real-case scenarios of PCA analyses on omics data.
...
`r msmbstyle::solution_begin()`
```{r, fig.cap = "Biplot of the `mulvey2015` data.", fig.width = 8, fig.height = 4}
...
`r msmbstyle::solution_begin()`
```{r, fig.cap = "Biplot of the `hyperLOPIT2015` data.", fig.width = 8, fig.height = 4}
fviz_pca(pca_hl)
fviz_pca_var(pca_hl)
```

```{r, fig.cap = "Biplot of the `hyperLOPIT2015` data showing the sub-cellular localisation of the proteins.", fig.width = 8, fig.height = 4}
