...
Parts of this chapter are based on chapter 6 from *Modern Statistical
...
*Modern Statistical for Modern Biology* [@MSMB], and in particlar
...
assumption** among the observations in a sample. A additional exercise
...
experimental design and stating the biological question of interest
before running experiment. Indeed, quoting the mathematician Richard
Hamming:
...
that occurs when researchers provide the right answer to the wrong
question.
