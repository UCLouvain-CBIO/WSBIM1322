...
`r msmbstyle::solution_begin()`
```{r, fig.cap = "Visualiation of the labelled and unlabelled data before (top) and after (bottom) classification.", fig.height = 10}
giris2_res <- giris2
...
compare each to the true results. Interprete these results.
`r msmbstyle::question_end()`
...
```{r, echo = FALSE, fig.cap = "The data is split into 3 folds. At each training/testing iteration, a different fold is used as test partition (orange) and the two other ones (white) are used to train the model.", out.width='100%', fig.align='center'}
