...
Perform a kNN classification setting k=5. How many unlabelled data
were assigned to any of the 14 classes?
...
all <- fData(hyperLOPIT2015)$markers
all[unknown] <- as.character(knn5)
