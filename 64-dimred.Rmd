...
however aren't equivalent at all if the transposed data used for
PCA. In our applications, we always normalise our data prior to any
analysis. The scaling during PCA should only be necessary if we want
to remove the effect of some features being (much more) highly
